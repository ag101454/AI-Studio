 ...
 * 
 * Provides OAuth login options.
 * 
 * Future: Each button will redirect to the respective OAuth provider.
 * The backend handles the OAuth flow and redirects back with a token.
 * 
 * API Flow:
 * 1. User clicks provider button
 * 2. Redirect to /api/auth/google (or github, microsoft)
 * 3. Provider authenticates user
 * 4. Callback to /api/auth/callback?provider=google&code=xxx
